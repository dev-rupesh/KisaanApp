...
public enum Task {
	...
	setting_version,
	list_commodity_price,add_commodity_price, search_commodity_price, delete_commodity_price, get_master, update_master, get_user_profile, list_market, update_commodity_price
}